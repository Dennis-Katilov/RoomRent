        ...
        <div class="booking_rooms">
            ...
            <div class="filter">
                <form method="post" action="<?php echo get_post_type_archive_link('room'); ?>">
                    ...
                    <select name="location_option">
                        <option value=""><?php esc_html_e('Select Location','roomrent'); ?></option>
                        <?php
                    ...
                    <select name="type_option">
                        <option value=""><?php esc_html_e('Select Type','roomrent'); ?></option>
                        <?php
                        $instance->get_terms_hierarchical('type',$_POST['type_option']);
                        ?>
                    </select>

                    <input type="submit" name="submit" value="<?php esc_html_e('Go!','roomrent'); ?>" />
            ...
            if(!empty($_POST['submit'])){
                ...
                if ( $search_listing->have_posts() ) {
                        ...
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            ...
                            if(!empty($locations)){
                                foreach($locations as $location){
                                    echo '<span class="location">'.esc_html__('Location: ','roomrent') . $location->name.'</span>';
                                }
                            }
                            ...
                            if(!empty($types)){
                                foreach($types as $type){
                                    echo '<span class="type">'.esc_html__('Type: ','roomrent') . $type->name.'</span>';
                                }
                            }
                            ?>
                    ...
                    echo esc_html__('No posts','roomrent');
                }
